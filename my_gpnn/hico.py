...
def parse_arguments():
    ...
    parser.add_argument('--image-root', default="/data1/tangjq/hico_20160224_det/images/test2015/", help='path to your HICO-DET images')
    ...
    parser.add_argument('--transformer', action='store_true', default=True, help='whether to use transformer')
    # i/o
